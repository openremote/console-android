...
class BleProvider(val context: Context) {
  ...
  companion object {
    ...
    private val SERVICE_GENERIC_ATTRIBUTE = UUID.fromString("00001801-0000-1000-8000-00805f9b34fb")
    private val CHARACTERISTIC_SERVICE_CHANGED =
      UUID.fromString("00002a05-0000-1000-8000-00805f9b34fb")
    private val CHARACTERISTIC_DEVICE_NAME = UUID.fromString("00002a00-0000-1000-8000-00805f9b34fb")
    private val CHARACTERISTIC_APPEARANCE = UUID.fromString("00002a01-0000-1000-8000-00805f9b34fb")
  ...
  fun enable(callback: BleCallback?) {
    ...
    sharedPreferences.edit().remove(bleDisabledKey).apply()
  ...
  fun disable(): Map<String, Any> {
    val sharedPreferences =
      context.getSharedPreferences(context.getString(R.string.app_name), Context.MODE_PRIVATE)
    sharedPreferences.edit().putBoolean(bleDisabledKey, true).apply()
  ...
  fun sendToDevice(characteristicID: String, value: Any, callback: BleCallback) {
    val characteristic =
      deviceCharacteristics
        .find { it.characteristic.uuid.toString() == characteristicID }
        ?.characteristic
        ...
        device.connectGatt(
          ...
          object : BluetoothGattCallback() {
                ...
                this?.services?.forEach { service ->
                  ...
                  service.characteristics.forEach { characteristic ->
                    ...
                    if (characteristic.isWritable()) {
                      deviceCharacteristics
                        .find { it.characteristic.uuid == characteristic.uuid }
                        ?.isWritable = true
                    }
                  }
            ...
            private fun handleCharacteristicStatus(
              ...
              val deviceCharacteristic = deviceCharacteristics.find {
                it.characteristic.uuid == readCharacteristic.uuid
              }
            ...
            private fun handleDeviceIndex(gatt: BluetoothGatt?) {
              if (readableDeviceIndex < deviceCharacteristics.size - 1) {
                gatt?.readCharacteristic(
                  deviceCharacteristics[++readableDeviceIndex].characteristic
                )
              } else {
                bleCallback.accept(
                  hashMapOf(
                    ...
                    "data" to
                      hashMapOf(
                        "attributes" to
                          deviceCharacteristics.map {
                            createAttributeMap(it)
                          }
                      ),
                  )
                )
